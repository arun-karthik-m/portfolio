          ...
          <AnimatePresence>
            {projects.map((project, index) => (
              <motion.div
                ...
                viewport={{ once: true, margin: "-50px" }}
                whileHover="hover"
                className="group relative rounded-2xl overflow-hidden bg-gradient-to-br from-gray-800 to-gray-900 border border-gray-700/50 hover:border-blue-500/30 transition-all duration-300 will-change-transform"
              >
              ...
              <div className="relative z-10 p-8 h-full flex flex-col">
                ...
                <div className="flex gap-4 pt-2">
                  <motion.a
                    ...
                    whileHover="hover"
                    whileTap="tap"
                    className="px-5 py-2.5 bg-gradient-to-r from-blue-600 to-blue-700 text-white rounded-lg font-medium text-sm flex-1 text-center shadow-lg shadow-blue-500/20 will-change-transform"
                  >
                    View Project
                  </motion.a>
                  <motion.a
                    ...
                    whileHover="hover"
                    whileTap="tap"
                    className="px-5 py-2.5 bg-gray-800/50 text-white rounded-lg font-medium text-sm border border-gray-700 flex items-center justify-center gap-2 flex-1 will-change-transform"
                  >
